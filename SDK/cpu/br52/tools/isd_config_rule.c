...
SDK_VERSION = JL709N_V3.0.0; //jenkins脚本生成
#else
SDK_VERSION = JL709N_V0.1.0;
#endif
...
#if (defined(TCFG_DEBUG_DLOG_ENABLE) && TCFG_DEBUG_DLOG_ENABLE && !TCFG_DEBUG_DLOG_FLASH_SEL)
// dlog配置区域
DLOG_ADR = CONFIG_DLOG_ADDR;
DLOG_LEN = CONFIG_DLOG_SIZE;
DLOG_OPT = CONFIG_DLOG_OPT;
#endif
