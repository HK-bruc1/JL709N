...
/* ADC 最大通道数 */
#define AUDIO_ADC_MAX_NUM           (3)
#define AUDIO_ADC_MIC_MAX_NUM       (7)
#define AUDIO_ADC_LINEIN_MAX_NUM    (3)
...
#define AUDIO_MIC0_CH0                BIT(0)    // PA1 差分N端PA2
#define AUDIO_MIC0_CH1                BIT(1)    // PA3 差分N端PA4
#define AUDIO_MIC0_CH2                BIT(2)    // 不支持

// TCFG_AUDIO_MIC1_AIN_SEL
#define AUDIO_MIC1_CH0                BIT(0)    // PA5 差分N端PA4
#define AUDIO_MIC1_CH1                BIT(1)    // PB6 差分N端PB5
#define AUDIO_MIC1_CH2                BIT(2)    // 不支持

// TCFG_AUDIO_MIC2_AIN_SEL
#define AUDIO_MIC2_CH0                BIT(0)    // PB8 差分N端PB7
#define AUDIO_MIC2_CH1                BIT(1)    // PA6 差分N端PA7
...
#define AUDIO_MIC_BIAS_CH2            BIT(2)    // PB6
#define AUDIO_MIC_BIAS_CH3            BIT(3)    // 不支持
#define AUDIO_MIC_BIAS_CH4            BIT(4)    // 不支持
#define AUDIO_MIC_LDO_PWR             BIT(5)    // PA0
#define AUDIO_MIC_BIAS_LP             BIT(6)    // 不支持
...
#define AUDIO_LINEIN0_CH1                BIT(1)    // PA3
#define AUDIO_LINEIN0_CH2                BIT(2)    // 不支持

// TCFG_AUDIO_LINEIN1_AIN_SEL
#define AUDIO_LINEIN1_CH0                BIT(0)    // PA5
#define AUDIO_LINEIN1_CH1                BIT(1)    // PB6
#define AUDIO_LINEIN1_CH2                BIT(2)    // 不支持

// TCFG_AUDIO_LINEIN2_AIN_SEL
#define AUDIO_LINEIN2_CH0                BIT(0)    // PB8
#define AUDIO_LINEIN2_CH1                BIT(1)    // PA6
...
* Description: 设置mic第一级/前级增益
* Arguments  : ch_map AUDIO_ADC_MIC_0/AUDIO_ADC_MIC_1/AUDIO_ADC_MIC_2/AUDIO_ADC_MIC_3/AUDIO_ADC_MIC_4,多个通道可以或上同时设置
*              level 前级增益档位(AUD_MIC_GN_0dB/AUD_MIC_GN_2dB/AUD_MIC_GN_6dB)
* Return	 : None.
