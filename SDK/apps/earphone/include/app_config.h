...
#ifndef LE_AUDIO_JL_DONGLE_UNICAST_WITCH_PHONE_CONN_CONFIG
#define LE_AUDIO_JL_DONGLE_UNICAST_WITCH_PHONE_CONN_CONFIG 0//br52暂不支持抢占
#endif
#else
#undef LE_AUDIO_JL_DONGLE_UNICAST_WITCH_PHONE_CONN_CONFIG
...
#if (TCFG_THIRD_PARTY_PROTOCOLS_ENABLE && (TCFG_THIRD_PARTY_PROTOCOLS_SEL & (RCSP_MODE_EN | GFPS_EN | MMA_EN | FMNA_EN | TUYA_DEMO_EN | REALME_EN | SWIFT_PAIR_EN | DMA_EN | CUSTOM_DEMO_EN | XIMALAYA_EN | AURACAST_APP_EN | MULTI_CLIENT_EN))) || ((TCFG_LE_AUDIO_APP_CONFIG & (LE_AUDIO_UNICAST_SINK_EN | LE_AUDIO_JL_UNICAST_SINK_EN)))
