#ifndef CONFIG_BOARD_JL709N_DEMO_CFG_H
#define CONFIG_BOARD_JL709N_DEMO_CFG_H
...
//*********************************************************************************//
/*软件IIC设置*/
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTC_06                             //软件IIC  CLK脚选择
#define TCFG_SW_I2C0_DAT_PORT               IO_PORTC_07                             //软件IIC  DAT脚选择
...
#define TCFG_EAR_DETECT_IRO1                    IO_PORTC_03                //入耳红外检测IO1
#define TCFG_EAR_DETECT_IRO1_LEVEL     			0                         //IOR1工作电平选择
#define TCFG_EAR_DETECT_IRO2                  	IO_PORTC_04//IO_PORT_DM//IO_PORTC_02                //入耳红外检测IO2-检测脚+
...
/*烧写器电流校准方案开启联系原厂*/
#define TCFG_BURNER_CURRENT_CALIBRATION         TCFG_CHARGE_ENABLE && DISABLE
//*********************************************************************************//
//                                  LED 配置                                       //
//*********************************************************************************//
 ...
 */
#define TCFG_IMU_SENSOR_PWR_PORT				IO_PORTC_03
...
#endif //CONFIG_BOARD_JL709N_DEMO
#endif //CONFIG_BOARD_JL709N_DEMO_CFG_H
