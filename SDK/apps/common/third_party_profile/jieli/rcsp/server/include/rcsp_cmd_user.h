...
//多场景切换
#define DHF_ANC_MULT_SCENE_BEGIN         0xD7
#define DHF_ANC_MULT_SCENE_END           0xD8
#define DHF_ANC_MULT_SCENE_MODE1         0x00    //场景1
#define DHF_ANC_MULT_SCENE_MODE2         0x01    //场景2
#define DHF_ANC_MULT_SCENE_INQUIRE       0x03    //app下发查询指令
