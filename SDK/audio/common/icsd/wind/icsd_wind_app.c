...
int audio_anc_wind_noise_process(u8 wind_lvl)
{
    ...
    if (anc_mode_get() == ANC_ON) {
        ...
        if (trigger_cfg) { //use anc_ext_tool cfg
            ...
            wind_lvl_det_anc.lvl1_thr = 30;
            wind_lvl_det_anc.lvl2_thr = 50;
            wind_lvl_det_anc.lvl3_thr = 70;
            wind_lvl_det_anc.lvl4_thr = 90;
            wind_lvl_det_anc.lvl5_thr = 120;
        }
