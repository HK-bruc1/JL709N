...
#if TCFG_AUDIO_ANC_ENABLE
c_SRC_FILES += \
	  audio/cpu/br52/audio_anc.c \
	  audio/cpu/br52/icsd_anc_user.c \

#endif

//Audio Accelerator
c_SRC_FILES += \
	  audio/cpu/br52/audio_accelerator/hw_fft.c \
...
c_SRC_FILES += \
	  ...
	  #audio/cpu/br52/audio_demo/audio_alink_demo.c \
	  #audio/cpu/br52/audio_demo/audio_pdm_demo.c
#endif
...
c_SRC_FILES += \
	  cpu/br52/setup.c \
	  cpu/br52/overlay_code.c \


#if TCFG_CHARGE_ENABLE
c_SRC_FILES += \
      cpu/br52/charge/charge.c \
      cpu/br52/charge/charge_config.c
#endif

#if TCFG_CHARGE_CALIBRATION_ENABLE
c_SRC_FILES += \
      cpu/br52/charge/charge_calibration.c
#endif

#if (TCFG_CHARGESTORE_ENABLE || TCFG_TEST_BOX_ENABLE || TCFG_ANC_BOX_ENABLE)
c_SRC_FILES += \
      cpu/br52/charge/chargestore.c \
	  cpu/br52/charge/chargestore_config.c
#endif
...
#if TCFG_LP_TOUCH_KEY_ENABLE
c_SRC_FILES += \
	  cpu/br52/periph/touch/lpctmu_hw.c \
	  cpu/br52/periph/touch/lp_touch_key.c \

#endif

#if 0
c_SRC_FILES += \
      cpu/br52/periph/mcpwm.c \
      cpu/br52/periph/rdec.c
#endif


#if TCFG_PWMLED_ENABLE
c_SRC_FILES += \
	  cpu/br52/periph/led/pwm_led.c
#endif


c_SRC_FILES += \
		cpu/br52/power/power_port.c \
		cpu/br52/power/power_gate.c \
		cpu/br52/power/key_wakeup.c \
		cpu/br52/power/dcvdd_ocp.c \
	  	cpu/br52/power/power_app.c \
