...
objs += \
	  $(ROOT)/cpu/br52/setup.o \
	  $(ROOT)/cpu/br52/overlay_code.o \


objs += \
      $(ROOT)/cpu/br52/charge/charge.o \
      $(ROOT)/cpu/br52/charge/charge_config.o

objs += \
      $(ROOT)/cpu/br52/charge/charge_calibration.o

objs += \
      $(ROOT)/cpu/br52/charge/chargestore.o \
	  $(ROOT)/cpu/br52/charge/chargestore_config.o



objs += \
	  $(ROOT)/cpu/br52/periph/touch/lpctmu_hw.o \
	  $(ROOT)/cpu/br52/periph/touch/lp_touch_key.o \


objs += \
      $(ROOT)/cpu/br52/periph/mcpwm.o \
      $(ROOT)/cpu/br52/periph/rdec.o


objs += \
	  $(ROOT)/cpu/br52/periph/led/pwm_led.o


objs += \
		$(ROOT)/cpu/br52/power/power_port.o \
		$(ROOT)/cpu/br52/power/power_gate.o \
		$(ROOT)/cpu/br52/power/key_wakeup.o \
